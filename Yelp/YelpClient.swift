...
let yelpConsumerKey = "SxYWuqKBEFGC45ftlXCqVA"
let yelpConsumerSecret = "kGpMzx8QPsDJy9q-qWXd1v7XynE"
let yelpToken = "imOrLYSGoiZM4o4lRF51bYsgEzL-JTKD"
let yelpTokenSecret = "XqCeUtu4hKTvcTkegB3a9SVemrQ"
...
class YelpClient: BDBOAuth1RequestOperationManager {
  ...
  func searchWithTerm(term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, radius: Double?, completion: ([Business]!, NSError!) -> Void) -> AFHTTPRequestOperation {
      ...
      if radius != nil {
        parameters["radius_filter"] = radius! * 1609.344
      }
